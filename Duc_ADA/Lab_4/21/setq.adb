...
package body Setq is
    ...
    function "+" ( X, Y: Rational ) return Rational is
    begin
        return Normalize( X.Numerator*Y.Denominator + Y.Numerator*X.Denominator,  X.Denominator * Y.Numerator );
    end;
    ...
    function "-" ( X, Y: Rational ) return Rational is
    begin
        return Normalize( X.Numerator*Y.Denominator - Y.Denominator*X.Denominator,  X.Denominator * Y.Numerator );
    end;
